About node2vec-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/node2vec-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/eliorc/node2vec

Documentation: http://snap.stanford.edu/node2vec/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5637&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/node2vec-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `node2vec` can be installed with `conda`:
...
```
mamba install node2vec
```

It is possible to list all of the versions of `node2vec` available on your platform with `conda`:
...
```
mamba search node2vec --channel conda-forge
```
...
mamba repoquery search node2vec --channel conda-forge

# List packages depending on `node2vec`:
mamba repoquery whoneeds node2vec --channel conda-forge

# List dependencies of `node2vec`:
mamba repoquery depends node2vec --channel conda-forge
```
